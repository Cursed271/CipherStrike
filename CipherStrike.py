...
def decrypt_data():
	user_input = console.input(rf"[#FFA500][?] Enter decryption password: ").strip()
...
def menu():
	...
	console.print(f"  [blue][>] 1. Encryption")
	console.print(f"  [blue][>] 2. Decryption")
	console.print(f"  [blue][>] 3. C2 Simulation")
	choice = console.input(rf"[#FFA500][?] Mode: ").strip()
...
└─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘
	""")
	console.print(rf"[bold green]+--------------------------------------------------------------+")
	console.print(rf"[bold green]  CipherStrike - Test Defenses. Simulate Threats. Strike Silently.")
